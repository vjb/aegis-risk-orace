...
export default function Chat({ onIntent }: ChatProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (isRiskQuery) {
            ...
            // Note: We'll update the rest of the flow in the async block below
            ...
            try {
                ...
                if (data.content?.hash) {
                    // Start a polling/waiting loop for the verdict if needed, 
                    // but for the demo we'll assume the listener fulfills it soon.
                    // We can finish the UI animation here
